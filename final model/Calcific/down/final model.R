...
# 获取当前特征组合
cb_n <- feature_combinations_n[11]
cb_n <- as.data.frame(cb_n)
cb_p <- feature_combinations_p[11]
...
train_features <- train_features[, -c(165:316, 355:358)]
train_features <- train_features[, -(165:479)]
train_labels <- train_data$type
test_features <- test_data[, !(colnames(test_data) == "type")]
test_features <- test_features[, -c(165:316, 355:358)]
test_features <- test_features[, -(165:479)]
test_labels <- test_data$type
test_features_Calcific_do=test_features
test_labels_Calcific_do=test_labels
saveRDS(test_features_Calcific_do,file = "D:\\Users\\Administrator\\Desktop\\machine learning\\feature\\test_features_Calcific_do.rds")
saveRDS(test_labels_Calcific_do, file = "D:\\Users\\Administrator\\Desktop\\machine learning\\label\\test_labels_Calcific_do.rds")
...
auroc
model_Calcific_do=rf_model
saveRDS(model_Calcific_do, file = "D:\\Users\\Administrator\\Desktop\\machine learning\\model\\model_Calcific_do.rds")
