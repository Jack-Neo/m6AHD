...
# 获取当前特征组合
cb_n <- feature_combinations_n[8]
cb_n <- as.data.frame(cb_n)
cb_p <- feature_combinations_p[8]
...
test_features_AC16Mat_do=test_features
test_labels_AC16Mat_do=test_labels
saveRDS(test_features_AC16Mat_do,file = "D:\\Users\\Administrator\\Desktop\\machine learning\\feature\\test_features_AC16Mat_do.rds")
saveRDS(test_labels_AC16Mat_do, file = "D:\\Users\\Administrator\\Desktop\\machine learning\\label\\test_labels_AC16Mat_do.rds")
...
auroc
model_AC16Mat_do=rf_model
saveRDS(model_AC16Mat_do, file = "D:\\Users\\Administrator\\Desktop\\machine learning\\model\\model_AC16Mat_do.rds")
