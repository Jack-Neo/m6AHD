...
# 获取当前特征组合
cb_n <- feature_combinations_n[22]
cb_n <- as.data.frame(cb_n)
cb_p <- feature_combinations_p[22]
...
test_features_hypertrophy_do=test_features
test_labels_hypertrophy_do=test_labels
saveRDS(test_features_hypertrophy_do,file = "D:\\Users\\Administrator\\Desktop\\machine learning\\feature\\test_features_hypertrophy_do.rds")
saveRDS(test_labels_hypertrophy_do, file = "D:\\Users\\Administrator\\Desktop\\machine learning\\label\\test_labels_hypertrophy_do.rds")
...
auroc
model_hypertrophy_down=rf_model
saveRDS(model_hypertrophy_down, file = "D:\\Users\\Administrator\\Desktop\\machine learning\\model\\model_hypertrophy_do.rds")
